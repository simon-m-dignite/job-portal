...
const Navbar = () => {
  ...
  return (
    <div
      className={`w-full py-6 flex items-center justify-between z-30 ${
    ...
    >
      ...
      <div className="hidden lg:flex items-center gap-x-8 relative">
        ...
        <div className="flex items-center w-80 gap-x-2 relative">
          ...
          {showNav && (
            <div className="w-40 h-auto bg-white absolute right-0 top-12 rounded-lg py-2 flex flex-col custom-shadow">
              <Link
