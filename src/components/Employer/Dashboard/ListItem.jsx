  ...
  return (
    <div className="w-full flex flex-col gap-1 border-b py-2 relative">
      ...
      <div className="w-full flex items-center justify-between gap-1 lg:gap-3">
        <div className="w-12 h-10 lg:h-11 rounded-full">
            <img src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=1780&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className="w-full h-full rounded-full"/>
        </div>
